...
const unhead_P0K_qHwZMUmUf30msYj1T_f9gwJDQSCmjvPVgNdAvK8 = defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const revive_payload_server_R_6mQkGEoiDJfCL3H6YZXOs7HzndoxPxxb9U8KAHBzI = defineNuxtPlugin({
...
const plugins = [
  payloadPlugin,
  unhead_P0K_qHwZMUmUf30msYj1T_f9gwJDQSCmjvPVgNdAvK8,
  plugin$1,
  revive_payload_server_R_6mQkGEoiDJfCL3H6YZXOs7HzndoxPxxb9U8KAHBzI,
  plugin,
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.16.0_@parcel+watcher@2.5.1_@types+node@22.13.10_db0@0.3.1_eslint@9.22.0_jiti@2.4.2__io_qvuatha57ukqh7gg4mt7eeyqci/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.16.0_@parcel+watcher@2.5.1_@types+node@22.13.10_db0@0.3.1_eslint@9.22.0_jiti@2.4.2__io_qvuatha57ukqh7gg4mt7eeyqci/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, withoutTrailingSlash as c, nuxtLinkDefaults as d, hasProtocol as h, joinURL as j, navigateTo as n, parseQuery as p, resolveRouteObject as r, server as s, tryUseNuxtApp as t, useRouter as u, withTrailingSlash as w };
